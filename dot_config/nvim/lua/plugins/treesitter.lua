...
return {
    {
        ...
        config = function()
            ...
            configs.setup({
                ensure_installed                  = { "bash", "c_sharp", "css", "csv", "dockerfile", "editorconfig", "git_config", "git_rebase", "gitattributes", "gitcommit", "gitignore", "go", "gomod", "gosum", "gotmpl", "groovy", "hcl", "helm", "html", "javascript", "json", "lua", "markdown", "powershell", "python", "requirements", "sql", "ssh_config", "terraform", "tmux", "typescript", "yaml" },
                sync_install                      = false,
                auto_install                      = true,
